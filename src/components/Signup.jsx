        ...
        <div className="login-page">
            ...
            <div className="login-container">
                ...
                <div className="input-field">
                    ...
                    <input className='input1' type="text" placeholder="First Name" /> <br /><br />
                    <i class="far fa-user"></i>
                    <input className='input1' type="text" placeholder="Last Name" /> <br /><br />
                    ...
                    <i class="fas fa-lock"></i>
                    <input className='input1' type="text" placeholder="Password Again" /><br /><br />
